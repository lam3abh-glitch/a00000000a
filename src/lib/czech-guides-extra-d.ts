...
// More about Czechia: transcribed from 100region.com (p8605).
const I = (name: string) => `https://i0.wp.com/100region.com/wp-content/uploads/${name}?ssl=1`;

export const czechGuidesExtraD: Guide[] = [
  {
    slug: "czech-tour-programs",
    title_ar: "برامج سياحية في التشيك",
    title_en: "Tour programs in Czechia",
    kicker_ar: "المزيد عن التشيك",
    kicker_en: "More about Czechia",
    image: I("2022/03/img_3726.jpg"),
    blocks: [
      {
        type: "P",
        ar: "برنامج سياحي الى التشيك لمدة 15 يوم",
        en: "A 15-day tourism program to Czechia",
      },
      {
        type: "P",
        ar: "لمحبي السياحة والسفر اقدم لكم برنامج سياحي متكامل الى التشيك لمدة 15 يوم ، متمنيا ان يكون غني ومثمر بوجود الكثير من الأماكن السياحية الرائعة والمميزة التي يمكنكم زيارتها خلال هذه الايام",
        en: "For lovers of tourism and travel, I present to you a complete tourism program to Czechia for 15 days, hoping it will be rich and fruitful with many wonderful and distinctive tourist places that you can visit during these days.",
      },
      {
        type: "P",
        ar: "فجمهورية التشيك تعد من الدول السياحية التي اكتملت فيها معالم السحر والجمال لتكون في مقدمة الدول السياحية التي يقصدها الكثير من السياح ، أتمنى ان تتعرفوا على أجمل أماكنها وملامحها الفاتنة والتي تتنوع بين الطبيعية والتاريخية والثقافية والسياحية والترفيهية مما سيوفر لكم اقامة سعيدة ومميزة باذن الله",
        en: "The Czech Republic is one of the tourist countries where the features of charm and beauty are complete, putting it at the forefront of the tourist countries sought by many tourists. I hope you get to know its most beautiful places and captivating features, which vary between natural, historical, cultural, touristic and recreational, which will provide you with a happy and distinctive stay, God willing.",
      },
      {
        type: "H3",
        noNumber: true,
      ...
      },
      {
        ...
        en: "Arrival at the city of Prague, the capital of the Czech Republic, one of the oldest European cities, nicknamed the Golden City. After arrival, you should head directly to the hotel and get some rest.",
      },
      {
        type: "P",
        ar: "بعدها عليكم التجول في المدينة لمشاهدة ملامحها السياحية المذهلة والتعرف على بعض من أسواقها التقليدية وبعض من مطاعمها الراقية وشوارعها الرئيسية",
        en: "After that, you should walk around the city to see its amazing touristic features and get to know some of its traditional markets, some of its upscale restaurants and its main streets.",
      },
      {
        type: "P",
      ...
      },
      {
        ...
        en: "You should go to Petřín Tower and Park, distinguished by its green nature and pleasant atmosphere, suitable for family trips as it offers you calm sittings in the lap of nature, which attracts many tourists to visit it. Petřín Tower, built in 1891 to resemble the Eiffel Tower in Paris in its design, is located in the park.",
      },
      {
        type: "P",
      ...
      { type: "IMG", src: I("2022/03/img_3352.jpg"), cap_ar: "ملاهي أكوادريم المائية", cap_en: "Aquapark Barrandov water park" },
      {
        ...
        en: "In the evening you should go to Wenceslas Square, one of the most famous recreational destinations that offers you an enjoyable time, as it includes many cafes, restaurants and shops.",
      },
      {
        type: "H3",
        noNumber: true,
      ...
      { type: "IMG", src: I("2022/03/img_3348.jpg"), cap_ar: "مدينة كارلوفي فاري", cap_en: "The city of Karlovy Vary" },
      {
        ...
        en: "After that you should visit Diana Tower, distinguished by its refined atmosphere, and it will also offer you an amazing view of the forests away from the hustle and bustle of the city.",
      },
      {
        type: "P",
        ar: "بعدها عليكم زيارة بيت الفراشات والذي لا يمكن تفويته وهو من الأماكن السياحية المميزة ، ويضمن لك اوقات جميلة ورائعة",
        en: "After that you should visit the Butterfly House, which cannot be missed and is one of the distinctive tourist places, guaranteeing you beautiful and wonderful times.",
      },
      {
        type: "P",
        ar: "بعدها عليكم زيارة الأسواق حيث تضم المدينة العديد منها والتي توفر لكم فرصة تسوق ممتعة من خلال التجول بين شوارعها لشراء الهدايا التذكارية وما شابه ، ويعد بيت الزجاج من أشهر محالات بيع الهدايا التذكارية هناك",
        en: "After that you should visit the markets, as the city has many of them offering you an enjoyable shopping opportunity by walking through its streets to buy souvenirs and the like, and the Glass House is one of the most famous souvenir shops there.",
      },
      {
        type: "H3",
        noNumber: true,
      ...
      { type: "IMG", src: I("2022/03/img_3347.jpg"), cap_ar: "قلعة لوكيت", cap_en: "Loket Castle" },
      {
        ...
        en: "After that you should visit the Historical Motorcycle Museum, located a short drive from Karlovy Vary in the small village of Bečov nad Teplou, containing more than 40 machines and motorcycles and many artifacts related to motorcycles, engines and tools. The museum also contains distinctive exhibitions, tableware, weapons and small toys, and you can walk through the streets of the small quiet village after visiting the museum and seeing the best old historical landmarks.",
      },
      {
        type: "P",
        ar: "بعدها عليكم التوجه الى برج ديانا لوكوت والذي يقع في البلدة القديمة ويبلغ ارتفاعه 35 متر ، ويعتبر من أشهر الأماكن السياحية ، حيث يمكنكم الوصول الى البرج سيرا على الأقدام في مدة لا تتجاوز 30 دقيقة ، وسوف تمرون في طريقكم للبرج على العديد من المباني التاريخية العريقة ، ويتكون البرج من 5 طوابق ويحتوي على مصعد يبلغ طوله 25 متر ، ويوجد مطعم خاص بالبرج يقدم وجبات مميزة للسياح ، وحديقة حيوانات صغيرة مخصصة للأطفال ، ويوجد فيه أبراج مراقبة تدل على روعة الهندسة المعمارية فهي مثيرة للاهتمام وتستحق الزيارة",
        en: "After that you should head to Diana Loket Tower, located in the old town with a height of 35 meters, considered one of the most famous tourist places. You can reach the tower on foot in no more than 30 minutes, and on your way to the tower you will pass by many ancient historical buildings. The tower consists of 5 floors and has an elevator 25 meters long. There is a restaurant belonging to the tower offering distinctive meals for tourists, and a small zoo dedicated to children, and there are watchtowers indicating the splendor of the architecture, which are interesting and worth visiting.",
      },
      {
        type: "P",
        ar: "بعدها عليكم التوجه الى الينابيع الساخنة والتي يأتي الكثير من السياح من مختلف أنحاء العالم بغرض السياحة العلاجية ، حيث تعد الينابيع الساخنة من أهم الأماكن السياحية التي تعتبر من المنتجعات الصحية المميزة هناك ، وتتواجد خمسة ينابيع ساخنة يحيط بها العديد من التماثيل ، ويوجد سخان خاص يطلق النار على 2000 لتر من المياه المعدنية لتسخينها كل دقيقة ، وقد تم تزيين المكان بالديكورات الخشبية الرائعة ذات اللون الأبيض ، وقد تم بناء ذلك المكان على الطراز السويسري بزخارف متشابكة من الدانتيل",
        en: "After that you should head to the hot springs, which many tourists come to from different parts of the world for the purpose of therapeutic tourism, as the hot springs are one of the most important tourist places, considered distinctive health resorts there. There are five hot springs surrounded by many statues, and there is a special heater that fires at 2000 liters of mineral water to heat it every minute, and the place has been decorated with wonderful white wooden decorations, built in the Swiss style with interlocking lace ornaments.",
      },
      {
        type: "H3",
        noNumber: true,
      ...
      { type: "IMG", src: I("2022/03/img_3346.jpg"), cap_ar: "مدينة السبا في كارلوفي فاري", cap_en: "The Spa town in Karlovy Vary" },
      {
        ...
        en: "After that you should visit the Karlovy Vary Museum and Art Gallery, one of the beautiful places, through which you can learn about the ancient history of this city. It contains artifacts and many historical books and paintings made by great artists, and it also contains a gallery dedicated to attractive arts offering workshops that create distinctive paintings and statues. This museum offers you the chance to see the most beautiful arts and enjoy the musical concerts and theatrical performances held in it.",
      },
      {
        type: "P",
        ar: "بعدها عليكم التوجه الى كنيسة القديسة مريم والتي تقع في قلب منطقة السبا في المدينة ، وهي مكان رائع يحتوي على مجموعة متنوعة من المنحوتات والتحف الأثرية والدينية المميزة واللوحات الدينية والكتب المقدسة الى جانب وجود مقبرة خاصة بالسكان المحليين موجودة هناك منذ فترة طويلة",
        en: "After that you should head to the Church of St. Mary Magdalene, located in the heart of the spa area of the city. It is a wonderful place containing a diverse collection of sculptures and distinctive archaeological and religious artifacts, religious paintings and holy books, alongside a cemetery for local residents that has been there for a long time.",
      },
      {
        type: "H3",
        noNumber: true,
      ...
      { type: "IMG", src: I("2022/03/img_3345.jpg"), cap_ar: "مدينة ماريانسكي لازني", cap_en: "The city of Mariánské Lázně" },
      {
        ...
        en: "After that you should visit the Bohemian Garden, one of the most famous tourist landmarks, as it contains a miniature collection of many famous palaces and castles in Czechia.",
      },
      {
        type: "P",
        ar: "بعدها عليكم زيارة منتزه الأعمدة وهو من المعالم الأكثر شهرة في المدينة كونه يتميز بفن عمارته الفريد ، ويعد مكانا مناسبا للتنزه والاسترخاء ، كما أنه يضم 3 ينابيع ماء علاجية صالحة للشرب",
        en: "After that you should visit the Colonnade Park, one of the most famous landmarks in the city as it is distinguished by its unique architecture. It is a suitable place for strolling and relaxing, and it also contains 3 therapeutic drinking-water springs.",
      },
      {
        type: "P",
        ar: "بعدها عليكم زيارة النافورة الراقصة وهي من أجمل المعالم السياحية والتي تجذب اليها الكثير من الزوار لمشاهدة عروض الماء على ألحان الموسيقى وخاصة في الليل ، فيبدو المكان حولها راقي وأجوائه رومانسية ، حيث يمكنكم قضاء فترة المساء بالكامل في هذا المكان الساحر",
        en: "After that you should visit the Singing Fountain, one of the most beautiful tourist landmarks, attracting many visitors to watch water shows set to musical melodies, especially at night, where the place around it appears elegant and its atmosphere romantic, and you can spend the whole evening in this enchanting place.",
      },
      {
        type: "H3",
        noNumber: true,
      ...
      },
      {
        ...
        en: "I suggest that this day be a free day, in which you can relax at the hotel or choose your various activities in this city, such as shopping, walking around freely on foot, or tasting Czech food at one of the restaurants there before leaving it.",
      },
      {
        type: "H3",
        noNumber: true,
      ...
      { type: "IMG", src: I("2022/03/img_3344.jpg"), cap_ar: "مدينة تشيسكي كروملوف", cap_en: "The city of Český Krumlov" },
      {
        ...
        en: "Upon arrival in Český Krumlov, you should explore it completely, as it is a city distinguished by a wonderful view of many valleys and hills from the south and west sides. It is also distinguished by many markets containing a large group of major shops, offering tourists the chance to buy souvenirs, imitation jewelry, handicraft products and antiques, in addition to children's toys. There is also a group of lakes on whose banks wonderful celebrations and some theatrical and musical performances are held, alongside many hotels, cafes and restaurants distinguished by their reasonable prices to suit all tastes and categories.",
      },
      {
        type: "P",
        ar: "وبعد الظهر عليكم زيارة قصر كروملوف وهو ثاني أكبر قصور العالم في تشيسكي كروملوف ، ويضم برج يمكنكم الصعود الى اعلاه لمشاهدة اطلالته الساحرة على المدينة بأكملها",
        en: "In the afternoon you should visit Krumlov Castle, the second largest castle complex in the world, in Český Krumlov, which includes a tower you can climb to the top of to see its enchanting view over the whole city.",
      },
      {
        type: "H3",
        noNumber: true,
      ...
      { type: "IMG", src: I("2022/03/img_3342.jpg"), cap_ar: "جبل كليت", cap_en: "Mount Kleť" },
      {
        ...
        en: "In the evening, I suggest it be free time for your favorite activities.",
      },
      {
        type: "H3",
        noNumber: true,
      ...
      { type: "IMG", src: I("2022/03/img_3341.jpg"), cap_ar: "قلعة تشيسكي كروملوف", cap_en: "Český Krumlov Castle" },
      {
        ...
        en: "After that you should go to the Barber's Bridge, named after the group of barbers who lived in this area, whose old medieval houses still stand along the riverbanks to this day. It is a wooden bridge connecting the old town on the Vltava River with the castle, and on both sides of the bridge there are two statues, one of the crucified Jesus and the second of St. John of Nepomuk, the same statue found on Charles Bridge in the capital Prague.",
      },
      {
        type: "P",
        ar: "بعدها عليكم التوجه لمركز ايغون شيلي للفنون والذي سمي بهذا الاسم نسبة الى الفنان ايغون شيلي وهو رسام من أصل نمساوي أبدع في رسم العديد من اللوحات الزيتية التي تعبر عن المناظر الطبيعية ، وأنشأ مركز ايغون شيلي للفنون في تشيسكي كروملوف ، وتم تجميع لوحاته الفنية فيه ، يأتي الى هذا المركز آلاف السياح كل عام ليشاهدوا أعماله التي لاقت شهرة عالمية كبيرة واللوحات التي تعبر عن مسيرة حياته",
        en: "After that you should head to the Egon Schiele Art Centre, named after the artist Egon Schiele, an Austrian painter who excelled in painting many oil paintings expressing landscapes. The Egon Schiele Art Centre was established in Český Krumlov, and his artworks were gathered there. Thousands of tourists come to this center every year to see his works, which achieved great worldwide fame, and paintings expressing the course of his life.",
      },
      {
        type: "H3",
        noNumber: true,
      ...
      },
      {
        ...
        en: "In the morning you should return to the city of Prague and stay there until departure.",
      },
      {
        type: "P",
      ...
      { type: "IMG", src: I("2022/03/img_3340.jpg"), cap_ar: "بلدة بيرون", cap_en: "The town of Beroun" },
      {
        ...
        en: "After that you should visit the Český Kras nature reserve, one of the best natural areas in Beroun, located in northern Bohemia, distinguished by its moderate climate, its richness of stunning natural scenery, and its sandy soil. It offers tourists the enjoyment of walking and strolling amid vast green spaces, and you can also ride bicycles and tour it inside various gardens and squares. The Český Kras reserve contains a collection of rare rocks and stones and many different animals and beautiful birds.",
      },
      {
        type: "P",
        ar: "بعدها انصحكم بالتوجه الى محمية كريفوكلاتسو والتي تقع على ضفاف نهر بيرونكا في الجزء الغربي من بيرون وبالقرب من مرتفعات فرشوفنيا ، وهي عبارة عن مجموعة كبيرة من الغابات المعتدلة والتي تمتد على مساحة تبلغ 628 كم ، وتتميز بوجود مزيج رائع من الصخور الجافة والبركانية التي تزين وتغطي قمم بعض التلال في منظر يأسر القلوب بجماله",
        en: "After that I advise you to head to the Křivoklátsko reserve, located on the banks of the Berounka River in the western part of Beroun and near the Vraší hills. It is a large group of temperate forests spread over an area of 628 km, distinguished by a wonderful mix of dry and volcanic rocks that decorate and cover the tops of some hills in a view that captivates hearts with its beauty.",
      },
      {
        type: "P",
        ar: "بعدها باستطاعتكم الذهاب الى حديقة الحيوانات ميدفيداريوم والتي تتميز بجمال تنظيمها وترتيبها واذا كنتم من عشاق مشاهدة الدببة فيمكنكم ان تجدوا ذلك فيها ، تقع الحديقة وسط اقليم بوهيميا في منطقة جبل تاون ، وتتميز بأن معظم الحيوانات فيها تتكون من الدببة بمختلف أشكالها وأنواعها مع القليل من الحيوانات الأخرى",
        en: "After that you can go to the Medvědárium zoo, distinguished by the beauty of its organization and arrangement, and if you love watching bears you can find that there. The zoo is located in the middle of the Bohemia region in the Mount Town area, distinguished by the fact that most of its animals are bears of various shapes and kinds, along with a few other animals.",
      },
      {
        type: "H3",
        noNumber: true,
      ...
      { type: "IMG", src: I("2022/03/img_3339.jpg"), cap_ar: "مدينة برنو", cap_en: "The city of Brno" },
      {
        ...
        en: "After that you can go to Špilberk Castle, whose construction dates back to the Middle Ages, and it was a military prison. Now it has become an ancient archaeological museum of the city of Brno and one of its important cultural centers, sought by tourists annually to enjoy watching those cultural artifacts.",
      },
      {
        type: "P",
        ar: "بعدها يمكنكم زيارة محمية مورافيان كارست وهي من أجمل المحميات الطبيعية وأجمل المناطق السياحية في التشيك ، تضم مناظر خلابة غاية في الجمال ، تقع المحمية في الشمال من مدينة برنو ، ويوجد فيها حوالي 1100 كهف ووادي على مساحة حوالي 92 كم ، وتضم ممرا ضيقا ارتفاعه حوالي 100متر تشكل بسبب انهيار سقف أحد الكهوف عند بداية نهر أبايس ، وتعد هذه المنطقة من أكثر أماكن الجذب السياحي شهرة في برنو حيث يزورها أعداد كبيرة من السياح كل عام",
        en: "After that you can visit the Moravian Karst reserve, one of the most beautiful nature reserves and tourist areas in Czechia, containing extremely beautiful scenery. The reserve is located north of the city of Brno, and it contains about 1100 caves and valleys over an area of about 92 km, and includes a narrow passage about 100 meters high formed by the collapse of the roof of one of the caves at the beginning of the Punkva River. This area is one of the most famous tourist attractions in Brno, visited by large numbers of tourists every year.",
      },
      {
        type: "P",
        ar: "بعدها يمكنكم الذهاب الى فيلا توغندهات والتي تقع في حي الأثرياء في برنو ، وتعد من أجمل النماذج المعمارية والهندسية، وتتكون الفيلا من 3 طوابق رائعة ، ويتميز كل طابق بنموذج بناء مميز مختلف عن الآخر ، وذلك بسبب الموقع المنحدر الذي بنيت عليه الفيلا ، حيث تأسست على تل شديد الانحدار ، فاذا كنتم من عشاق مشاهدة روعة المعمار الفريد مع غرابة الموقع المنحدر فلا تفوتوا زيارة هذا المكان الجميل أثناء السياحة في التشيك",
        en: "After that you can go to Villa Tugendhat, located in the wealthy district of Brno, one of the most beautiful architectural and engineering models. The villa consists of 3 wonderful floors, each floor distinguished by a construction model different from the other, due to the sloping site on which the villa was built, having been founded on a steeply sloping hill. If you love seeing the splendor of unique architecture combined with the strangeness of the sloping site, do not miss visiting this beautiful place during your tourism in Czechia.",
      },
      {
        type: "H3",
        noNumber: true,
      ...
      { type: "IMG", src: I("2022/03/img_3337.jpg"), cap_ar: "مول نوفي سيتمشوف", cap_en: "Novy Smíchov Mall" },
      {
        ...
        en: "After that you can head to Arkády Pankrác Mall, one of the important shopping centers in Prague, containing more than 120 shops for the most famous global brands in accessories, fashion, electronics, sports equipment and much more varied merchandise. In addition, the mall offers many restaurants, cafes and a large hypermarket.",
      },
      {
        type: "P",
      ...
      },
      {
        ...
        en: "I suggest that this day be a free day, in which you can relax at the hotel or choose your various activities in the city of Prague, or head to Charles Bridge again to experience its distinctive atmosphere, as it is the ideal place to spend an enjoyable time.",
      },
      {
        type: "H3",
        noNumber: true,
      ...
      },
      {
        ...
        en: "In the morning, get ready to depart and return to your country, in God's care and protection.",
      },
    ],
  },
];

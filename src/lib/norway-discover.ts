...
export const norwayDiscoverGuide: Guide = {
  ...
  image: HERO,
  blocks: [
    { type: "H3", ar: "تعرف على كل ما يخص مملكة النرويج قبل السفر لها", en: "Everything about the Kingdom of Norway before you travel", noNumber: true },
    {
      type: "LIST",
      ar: [
        "أصل تسمية النرويج",
        ...
        "فن العمارة في النرويج",
        "اللغة في النرويج",
        "الديانة في النرويج",
        "الحيوانات التي تشتهر بها النرويج",
        "مناخ النرويج",
        "المواصلات والانتقال في النرويج",
        "الثقافة والفنون في النرويج",
        "كيف الوصول الى النرويج",
      ],
      en: [
        "The origin of the name Norway",
        ...
        "Language in Norway",
        "Religion in Norway",
        "The animals Norway is famous for",
        "The climate of Norway",
        "Transport and getting around in Norway",
        "Culture and the arts in Norway",
        "How to reach Norway",
      ],
    },

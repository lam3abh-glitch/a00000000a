...
export const scotlandLandmarkGuides: Guide[] = [
  {
    ...
    blocks: [
      ...
      {
        type: "P",
        ar: "قلعة أدنبره هي قلعة تاريخية تسيطر على أفق مدينة أدنبره من موقعها على قلعة الصخرة ، وقد أظهرت البحوث الأثرية وجود احتلال بشري بالموقع منذ العصر الحديدي ، وكانت القلعة قلعة ملكية منذ عهد الملك ديفيد الاول في القرن الثاني عشر ، وبقيت مقر إقامة ملكية حتى عام 1633 ، ومن القرن الخامس عشر انخفض دورها السكني وصارت ثكنات عسكرية",
        en: "Edinburgh Castle is a historic fortress that dominates the skyline of Edinburgh from its position on Castle Rock. Archaeological research has shown human occupation of the site since the Iron Age. It has been a royal castle since the reign of King David I in the twelfth century and remained a royal residence until 1633; from the fifteenth century its residential role declined and it became a military barracks.",
      },
      {
        type: "P",
        ar: "وقد شهدت القلعة 26 حصاراُ في تاريخها الممتد لأكثر من 1100 عام ، مما يجعلها أكثر الأماكن المحاصرة في بريطانيا العظمى ، وهي اليوم تحت رعاية البيئة التاريخية لاسكتلندا ، وتعد أكثر مناطق الجذب مدفوعة الأجر في اسكتلندا بأكثر من مليوني زائر في عام 2017 ، أي ما يعادل 70% من زوار أدنبره ، كما أنها الخلفية التي تقام عليها شمعة أدنبره العسكرية",
        en: "The castle has endured 26 sieges in a history spanning more than 1,100 years, making it the most besieged place in Great Britain. Today it is in the care of Historic Environment Scotland and is the most visited paid attraction in Scotland, with more than two million visitors in 2017 — around 70% of all visitors to Edinburgh. It is also the backdrop for the Edinburgh Military Tattoo.",
      },
      { type: "IMG", src: U("2022/09/img_2818.jpg"), cap_ar: "قاعة ادنبره", cap_en: "The Great Hall, Edinburgh" },
      {
        type: "P",
        ar: "وتعد أدنبره من أهم مراكز عصر التنوير ، وقد أدرجت بلدتاها القديمة والحديثة على قائمة مواقع التراث العالمي في عام 1995 ، وتحتوي المدينة على أكثر من 4500 مبنى مدرج",
        en: "Edinburgh was one of the most important centres of the Enlightenment, and both its Old and New Towns were inscribed as World Heritage Sites in 1995. The city holds more than 4,500 listed buildings.",
      },
      {
        type: "P",
        ar: "أما الجزء الأقدم من القلعة فهو كنيسة سانت مارغريت التي تعود الى القرن الثاني عشر ، وقد أقام جيمس الرابع قلعة كونوي في عام 1510",
        en: "The oldest part of the castle is St Margaret's Chapel, dating from the twelfth century, and James IV built the Great Hall in 1510.",
      },
      {
        type: "P",
        ar: "وتعود بطارية نصف القمر الى ريجنت مورتون في أواخر القرن السادس عشر",
        en: "The Half Moon Battery dates from the time of Regent Morton in the late sixteenth century.",
      },
      { type: "IMG", src: U("2022/09/img_2815.jpg"), cap_ar: "احد المدافع الموجودة بقلعة ادنبره", cap_en: "One of the cannon at Edinburgh Castle" },
      { type: "IMG", src: U("2022/09/img_2814.jpg"), cap_ar: "احد زوايا المباني بقلعة ادنبره", cap_en: "A corner of the buildings at Edinburgh Castle" },
      { type: "H3", ar: "وصف قلعة ادنبره", en: "A description of Edinburgh Castle", noNumber: true },
      {
        type: "P",
        ar: "في جنوب جبل ميلز القريب تتعرج الطريق يمينا من خلال بوابة الى أعلى جزء من قلعة الصخرة ، حيث كنيسة سانت مارغريت ، أقدم مبنى موجود في ادنبرة ، ويقال انه ربما بنيت من قبل ديفيد الأول ، أو ألكسندر الأول في ذكرى أمهما الملكة مارغريت في عام 1130 تقريبا ، الى جانب المصلى يقف مونس ميج ، وهو عبارة عن بندقية حربية عملاقة تعود الى القرن الخامس عشر بنيت في مونس (تعرف الآن ببلجيكا) في عام 1449 هذا وتوجد المجموعة الرئيسية للمباني على قمة صخرة القلعة حول ميدان التاج ، التي يسيطر عليها ضريح النصب التذكاري للحرب الوطنية الأسكتلندية ، وفي مقابله توجد القاعة الكبرى التي بنيت لجيمس الرابع (1488-1513) كقاعة احتفالات ، واستخدمت كمكان للاجتماع للبرلمان الأسكتلندي حتى عام 1639 ، وتتمثل أبرز سماتها في السقف الأصلي للمطرقة الذي يعود الى القرن السادس عشر ، واستخدمت القاعة الكبرى تحت القلعة بشكل مختلف كمخازن ومخابز وأيضا كسجن ، وجرى تجديد هذه المخازن لتشبه سجون القرن الثامن عشر وأوائل القرن التاسع عشر ، حيث يمكن رؤية الجدران التي نحتها السجناء الفرنسيون والأمريكيون على الأبواب الخشبية القديمة وعلى الجانب الشرقي من الساحة يوجد القصر الملكي الذي بني في القرنين الخامس عشر والسابع عشر ، حيث سلسلة من اللوحات التاريخية تؤدي الى تسليط الضوء على القلعة ، وفيها غرفة محكمة البناء تسمى بشرف أسكتلندا ، تحوي ما يعرف بمجوهرات التاج الأسكتلندية وبقايا التاج والجواهر ، وهذه الغرفة مقفلة وتحوي التاج الذهبي الذي صنع في عام 1540 من ذهب روبرت الاكليل بروس في القرن الـ 14 ، وبقي التاج وحيدا حتى عثر على السيف والصولجان بعد بحث الروائي السير والتر سكوت في 1818 ، حيث جرى الكشف عنهما وعرضهما مع التاج وجدير بالذكر أن القلعة تحوي العديد من المتاحف التاريخية ، يصحب الزائر اليها العديد من المرشدين السياحيين ، وفيها أجهزة الكترونية صوتية مبرمجة لثماني لغات ، وذلك لفهم ما يقوله المرشد عن تاريخ القلعة ومرافقها",
        en: "South of nearby Mills Mount the road winds right through a gate to the upper part of Castle Rock, where St Margaret's Chapel stands — the oldest surviving building in Edinburgh, said to have been built perhaps by David I or Alexander I in memory of their mother Queen Margaret around 1130. Beside the chapel stands Mons Meg, a giant siege gun from the fifteenth century built in Mons (now in Belgium) in 1449. The main group of buildings stands on the summit of the castle rock around Crown Square, dominated by the shrine of the Scottish National War Memorial; opposite it is the Great Hall built for James IV (1488–1513) as a hall of ceremony, used as the meeting place of the Scottish Parliament until 1639, its most striking feature the original sixteenth-century hammerbeam roof. The vaults beneath the castle were used variously as stores and bakehouses and also as a prison; these stores have been restored to resemble the prisons of the eighteenth and early nineteenth centuries, where you can see the walls carved by French and American prisoners on the old wooden doors. On the east side of the square stands the Royal Palace, built in the fifteenth and seventeenth centuries, where a series of historic rooms leads to the highlights of the castle, including the strongroom called the Honours of Scotland, holding what are known as the Scottish crown jewels and the remains of the crown and gems. This room is locked and contains the golden crown made in 1540 from the gold of Robert the Bruce's coronet of the fourteenth century. The crown remained alone until the sword and sceptre were found after a search by the novelist Sir Walter Scott in 1818, when they were revealed and displayed with the crown. It is worth noting that the castle holds many historical museums, that visitors are accompanied by many guides, and that it has electronic audio devices programmed in eight languages so you can understand what the guide says about the history of the castle and its buildings.",
      },
      ...
      {
        type: "P",
        ar: "قلعة ادنبرة هى قلعة رائعة فى قلب ادنبرة عاصمة اسكتلندا وهى من اجمل واشهر القلاع الموجودة فى غرب اوروبا ، وتفتح القلعة ابوابها من الساعة التاسعة والنصف صباحا وحتى الخامسة مساء من كل يوم ، وتذكرة الدخول الخاصة بها تقدر بــ 17 جنيه استرلينى للكبار وعشرة جنيهات استرلينى للاطفال قلعة ادنبرة تقع فى مكان مرتفع فى اسكتلندا ، لذا فهي تحتاج الى بعض المجهود للوصول لها ، ويرجى العلم انه لا يوجد مكان لركن السيارة اذا انتويت الصعود بالسيارة فالقلعة تقع على قمة جبل , وبالدخول يمكنك الحصول على جهاز اوديو مجانى يمكنك سماع تاريخ القلعة به حيث مزودا بثمانية لغات مختلفة تتيح لك التعرف اكثر على تاريخ القلعة بالطبع تنتشر محلات الهدايا و التذكارات بالقرب من القلعة و ان كانت اسعارها اعلى نسبيا من الشراء من منتصف المدينة فى شارع برنسيس وايضا يوفر محلات بسيطة للاكل الخفيف والسريع بجوار القلعة",
        en: "Edinburgh Castle is a magnificent fortress in the heart of Edinburgh, the capital of Scotland, and one of the loveliest and most famous castles in western Europe. It opens its doors from half past nine in the morning until five in the afternoon every day, and the entry ticket is about 17 pounds sterling for adults and ten pounds for children. The castle stands on high ground, so it takes some effort to reach, and please note there is no parking if you intend to drive up, as the castle sits on the top of a hill. On entry you can get a free audio device on which you can hear the history of the castle, provided in eight different languages so you can learn more about its past. Gift and souvenir shops are of course found near the castle, although their prices are relatively higher than buying in the middle of the city on Princes Street, and there are also simple outlets for light and fast food beside the castle.",
      },
    ],
  },

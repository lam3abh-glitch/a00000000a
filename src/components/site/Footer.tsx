      ...
      <div className="mx-auto max-w-7xl px-6 py-16 grid gap-12 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><Link to={`/${lang}/countries`} className="hover:text-gold">{t[lang].nav.countries}</Link></li>
            <li><Link to={`/${lang}/continents/asia-australia`} className="hover:text-gold">{lang === "ar" ? "آسيا وأستراليا" : "Asia & Australia"}</Link></li>
            <li><Link to={`/${lang}/continents/europe`} className="hover:text-gold">{lang === "ar" ? "أوروبا" : "Europe"}</Link></li>
            <li><Link to={`/${lang}/continents/africa`} className="hover:text-gold">{lang === "ar" ? "أفريقيا" : "Africa"}</Link></li>
            <li><Link to={`/${lang}/continents/americas`} className="hover:text-gold">{lang === "ar" ? "الأمريكتان" : "Americas"}</Link></li>
          </ul>
        </div>
        <div>

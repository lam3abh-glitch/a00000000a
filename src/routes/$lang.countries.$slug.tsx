...
import { PortugalCountry } from "@/components/site/PortugalCountry";
    ...
    <div className="bg-cream">
      ...
      <section className="relative h-[70vh] min-h-[480px] bg-midnight">
        ...
        <div className="relative z-10 mx-auto max-w-7xl h-full flex flex-col justify-end px-6 pb-16 text-cream">
          ...
          {(() => {
            const stats = c.slug === "zimbabwe"
              ? [
                  { label_ar: "العاصمة", label_en: "Capital", value_ar: "هراري", value_en: "Harare" },
                  { label_ar: "العملة", label_en: "Currency", value_ar: "راند جنوب افريقيا", value_en: "South African rand" },
                  { label_ar: "السكان", label_en: "Population", value_ar: "16.5 مليون", value_en: "16.5 million" },
                  { label_ar: "المساحة", label_en: "Area", value_ar: "390.757 كم", value_en: "390,757 km" },
                  { label_ar: "الديانة", label_en: "Religion", value_ar: "المسيحية", value_en: "Christianity" },
                  { label_ar: "التأسيس", label_en: "Founded", value_ar: "1980", value_en: "1980" },
                ]
              : c.slug === "seychelles"
              ? [
              ...
              ? [
                  ...
                  { label_ar: "السكان", label_en: "Population", value_ar: "104.9 مليون", value_en: "104.9 million" },
                  { label_ar: "المساحة", label_en: "Area", value_ar: "1.104.300 كم", value_en: "1,104,300 km" },
                  { label_ar: "الديانة", label_en: "Religion", value_ar: "المسيحية", value_en: "Christianity" },
                  { label_ar: "التأسيس", label_en: "Founded", value_ar: "—", value_en: "—" },
                ]
              : c.slug === "uganda"
              ? [
              ...
              : c.slug === "portugal"
              ? [
                  { label_ar: "العاصمة", label_en: "Capital", value_ar: "لشبونة", value_en: "Lisbon" },
                  { label_ar: "العملة", label_en: "Currency", value_ar: "اليورو", value_en: "Euro" },
              ...
              ? [
                  ...
                  { label_ar: "العملة", label_en: "Currency", value_ar: "فرنك س ف ا غرب افريقيا", value_en: "West African CFA franc" },
                  { label_ar: "السكان", label_en: "Population", value_ar: "14.6 مليون", value_en: "14.6 million" },
                  { label_ar: "المساحة", label_en: "Area", value_ar: "196,723 كم²", value_en: "196,723 km²" },
                  { label_ar: "الديانة", label_en: "Religion", value_ar: "الاسلام", value_en: "Islam" },
      ...
      {c.slug === "uganda" ? (
        ...
        <PortugalCountry lang={lang} intro={lang === "ar" ? c.intro_ar : c.intro_en} />
      ) : c.slug === "argentina" ? (
      ...
      {c.slug === "usa" && (
        <section className="py-16 bg-vegasink">
          <div className="mx-auto max-w-4xl px-6">
            <div className={`mb-8 ${lang === "ar" ? "text-right" : "text-left"}`}>
              ...
              <h2 className="font-display text-3xl md:text-4xl vegas-neon-gold">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className={`group rounded-xl bg-vegasnight/70 vegas-tube-pink hover:-translate-y-1 transition-transform px-6 py-6 ${lang === "ar" ? "text-right" : "text-left"}`}
              >
                <div className="text-[10px] uppercase tracking-[0.3em] font-mono mb-2 vegas-neon-cyan">01</div>
                <div className="font-display text-xl text-vegasgold group-hover:text-vegaspink transition-colors">
              ...
              <Link
                ...
                className={`group rounded-xl bg-vegasnight/70 vegas-tube-cyan hover:-translate-y-1 transition-transform px-6 py-6 ${lang === "ar" ? "text-right" : "text-left"}`}
              >
                <div className="text-[10px] uppercase tracking-[0.3em] font-mono mb-2 vegas-neon-cyan">02</div>
                <div className="font-display text-xl text-vegasgold group-hover:text-vegaspink transition-colors">
